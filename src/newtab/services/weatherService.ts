...
export class WeatherService {
  ...
  private static readonly CACHE_KEY = "tabra-weather";
  private static readonly FORECAST_CACHE_KEY = "tabra-forecast";
  private static readonly HOURLY_CACHE_KEY = "tabra-hourly";
